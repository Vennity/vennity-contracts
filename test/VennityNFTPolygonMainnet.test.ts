 ...
 */
describe(`VennityNFT (Polygon Mainnet)`, () => {
  ...
  let polygonMainnetProvider = new ethers.providers.JsonRpcProvider(
  ...
  let l1Wallet1: Wallet = new ethers.Wallet(privateKey1, polygonMainnetProvider)
  let l1Wallet2: Wallet = new ethers.Wallet(privateKey2, polygonMainnetProvider)
